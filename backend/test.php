...
var_dump(Villageois::all());
echo "<hr> Création d'un villageois <hr>";
$marilou = new Villageois("marilou@test2.com3", "test 42 ", "23", "f,dvbjvkd", "1995-01-01", "oui");
$alex = new Villageois("alex@test2.com3", "test 42 ", "23", "f,dvbjvkd", "1986-01-01", "oui");

echo "<hr> sauvegarde d'un villageois <hr>";

$marilou->villageois_nom = "Marilou";
$alex->villageois_nom = "Alex";

$marilou->save();
$alex->save();

// echo "<hr>Création proposition <hr>";
// $periode = "2022-06-01 - 2022-06-30";
// $proposition = new Proposition(1, "etat_enattente", "proposition environnementale", "une proposition environnementale", "2022-05-17", "quelquepart.jpg", "alex@test2.com3", 8, $periode);
// $proposition2 = new Proposition(1, "etat_enattente", "proposition construction", "une proposition de construction", "2022-05-17", "quelquepart.jpg", "marilou@test2.com3", 10, $periode);
// $proposition3 = new Proposition(1, "etat_encreation", "proposition food truck", "une proposition de foodtruck dans le village", "2022-05-17", "quelquepart.jpg", "alex@test2.com3", 7, $periode);
